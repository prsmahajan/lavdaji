...
export const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div
        className="pointer-events-none fixed left-0 top-0 z-40 hidden h-10 w-10 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/30 bg-background/10 shadow-sm backdrop-blur-3xl transition-[transform,opacity] duration-250 md:block"
        style={{
