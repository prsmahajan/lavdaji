...
export const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div
        className="pointer-events-none fixed left-0 top-0 z-40 hidden h-12 w-12 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary/30 bg-background/45 shadow-sm backdrop-blur-4xl transition-[transform,opacity] duration-250 md:block"
        style={{
